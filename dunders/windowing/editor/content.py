...
from dunders.windowing.core.fold_engine import FoldEngine, FoldRegistry
from dunders.windowing.core.indent_fold import IndentFoldRule
from dunders.windowing.core.macro import MacroRecorder, MacroStorage
...
class EditorContent(WindowContent):
    ...
    def _register_macro_replay(self, app, key: str, actions: list) -> None:
        ...
        not available in dunders.app.DundersApp, but Textual will resolve the
